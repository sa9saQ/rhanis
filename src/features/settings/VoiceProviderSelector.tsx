// Voice provider/model selector (koe-31u). OpenAI is active for M1; Google is a
// disabled preview until koe-zv3 wires the Gemini Live connection. The chosen
// value is a single "provider/model" string the backend persists; koe-zv3 acts
...
// preview until koe-zv3 wires the Gemini Live connection.
...
export function VoiceProviderSelector({
  ...
  return (
    <div className="koe-voice-provider-selector">
      <label htmlFor="koe-voice-provider-select" className="koe-label">
        声のプロバイダ
      </label>
      <select
        id="koe-voice-provider-select"
        value={value}
