...
- **プラン構造（Hermes 下敷き）**: Free / Plus / Pro / Ultra + **「支払い額×1.10（10%ボーナス）」クレジット** + 繰越上限 + **いつでもクレジット追加購入**。10%ボーナスは retail建てなので原価安、マージンは従量メーター単価に内包。`koe-3x6`。（**追記 2026-06-10 徹底レビュー: Hermes 実名は Free/Plus/Super/Ultra — 「Pro」は誤記〔公式X 2026-04-23 発表で確認〕。マージンは「実コスト×1.8〜2.0 パススルー型」必須〔+15-25%は赤字設計〕、決済 = Stripe 確定。確定ゲート = `koe-krv`、詳細 = `2026-06-10-exhaustive-review.md` §4**）
